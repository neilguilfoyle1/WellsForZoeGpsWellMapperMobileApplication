...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private boolean isEmailValid(String email) {
        ...
        String local = email.substring(indexOfAtSign > 0 ? indexOfAtSign : email.length()-1);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        //only called on populateAutoComplete() SDK >=14 hence warning below doesn't apply
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        UserLoginTask(String email, String password, Activity caller) {
            mEmail = email;
            mPassword = password;
            mCaller = caller;
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                if(!dl.TryLogin(mEmail, mPassword)){
            ...
            //TODO: load password hash from database by mEmail
            //TODO: comapare it to the HASH(mPassword), return true/false
        ...
        protected void onPostExecute(final String errorMessage) {
            ...
            if (errorMessage == null) {
                Intent intent = new Intent(mCaller, GpsLoadActivity.class);
